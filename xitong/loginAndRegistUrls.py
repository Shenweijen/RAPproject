...
#  定义 adminxiugaigerenxinxiact url响应，响应 loginAndRegistViews的adminxiugaigerenxinxiact方法    
    url(r'^adminxiugaigerenxinxiact/$', loginAndRegistViews.adminxiugaigerenxinxiact, name='adminxiugaigerenxinxiact'),
...
#  定义 userxiugaigerenxinxiact url响应，响应 loginAndRegistViews的userxiugaigerenxinxiact方法    
    url(r'^userxiugaigerenxinxiact/$', loginAndRegistViews.userxiugaigerenxinxiact, name='userxiugaigerenxinxiact'),

#  定义 repairmanindex url响应，响应 loginAndRegistViews的repairmanindex方法    
    url(r'^repairmanindex/$', loginAndRegistViews.repairmanindex, name='repairmanindex'),

#  定义 repairmanxiugaigerenxinxiact url响应，响应 loginAndRegistViews的repairmanxiugaigerenxinxiact方法    
    url(r'^repairmanxiugaigerenxinxiact/$', loginAndRegistViews.repairmanxiugaigerenxinxiact, name='repairmanxiugaigerenxinxiact'),
]
